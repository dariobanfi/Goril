...
import com.ambigioz.goril.models.objects.Coconut;
...
//        levelObjects.add(new LevelPair(new SquareGem(MathUtils.random(0, 100), Constants.SPAWN_HEIGHT, 15f, 15f), 8.0));
        levelObjects.add(new LevelPair(new Coconut(MathUtils.random(0, 100), Constants.SPAWN_HEIGHT, 25f, 1.0f), 1.0));
//        levelObjects.add(new LevelPair(new SquareGem(MathUtils.random(0, 100), Constants.SPAWN_HEIGHT, 35f, 35f), 4.0));
//        levelObjects.add(new LevelPair(new SquareGem(MathUtils.random(0, 100), Constants.SPAWN_HEIGHT, 35f, 35f), 0.5));
        return levelObjects;
    }
}
